    ...
    <div style={S.root}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .search-box:focus{outline:none;border-color:#333!important;box-shadow:0 0 0 3px rgba(249,115,22,.08)}
        .search-box::placeholder{color:#2a2a2a}
          ...
          <div style={S.hdrRow}>
            ...
            <div className="glass" style={S.statusPill}>
              {!checked ? <Spinner s={10}/> : <>
                ...
                <span style={{fontSize:11,fontWeight:500,color:srv?"#4ade80":"#555",letterSpacing:".02em"}}>
            ...
            {files.length===0 ? (
              <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:16,animation:"fadeUp .6s ease .1s both"}}>
                ...
                <div style={{textAlign:"center"}}>
                  ...
                  <p style={{fontSize:13,color:"#3a3a3a",marginTop:4}}>or click to browse · no restrictions on file types</p>
                </div>
              ...
              <p style={{fontSize:13,fontWeight:500,color:"#666"}}>
        ...
        {files.length>0 && results.length===0 && (
          <div>
            ...
            <div style={{...S.secRow,marginTop:28,animation:"fadeUp .4s ease .1s both"}}>
              ...
              <span style={{fontSize:11,color:"#2a2a2a"}}>{ALL_FORMATS.length} formats</span>
            </div>

            {/* Search */}
            <div style={{position:"relative",marginBottom:14,animation:"fadeUp .4s ease .15s both"}}>
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="#333" strokeWidth="1.3"
                  ...
                  {g.formats.map(f => {
                    ...
                    return (
                      <button key={f.ext} className="fmt-chip"
                        ...
                        onClick={()=>setFmt(f)}>
                        {f.label}
                        {needsSrv && !active && <span style={{fontSize:7,marginLeft:2,opacity:.4,verticalAlign:"super"}}>S</span>}
                      </button>
                    );
                  })}
                </div>
            ...
            {showQ && (
              <div style={{marginTop:12,padding:"14px 16px",borderRadius:12,animation:"fadeUp .3s ease"}}
                ...
                <input type="range" min="10" max="100" value={q}
                  ...
                  style={{"--q-pct":`${q}%`}}/>
                <div style={{display:"flex",justifyContent:"space-between",fontSize:10,color:"#252525",marginTop:5}}>
...
const S = {
  ...
  logoSub: { fontSize:11.5, color:"#444", fontWeight:400, letterSpacing:".03em", marginTop:1 },
  ...
  dzTag: { fontSize:10, fontWeight:600, color:"#333", background:"rgba(255,255,255,.02)",
    border:"1px solid #151515", borderRadius:5, padding:"3px 8px",
  ...
  secLabel: { fontSize:11, fontWeight:600, color:"#505050", textTransform:"uppercase", letterSpacing:".08em" },
  ...
  fName: { fontSize:13, fontWeight:500, color:"#c4c4c4", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" },
  fMeta: { fontSize:11, color:"#3a3a3a", marginTop:2, display:"flex", alignItems:"center", gap:8 },
  ...
  rmBtn: { background:"none", border:"none", color:"#333", cursor:"pointer", padding:4,
  ...
  gTab: { padding:"5px 12px", borderRadius:8, border:"1px solid #161616", background:"transparent",
    color:"#444", fontSize:12, fontWeight:500, fontFamily:"'Sora'",
  ...
  chip: { padding:"6px 14px", borderRadius:8, border:"1px solid #1a1a1a", background:"rgba(255,255,255,.015)",
    color:"#555", fontSize:12, fontWeight:600, fontFamily:"'JetBrains Mono'",
  ...
  modeNote: { textAlign:"center", fontSize:11, color:"#222", marginTop:10, letterSpacing:".02em" },
  ...
  footer: { textAlign:"center", marginTop:36, fontSize:11.5, color:"#222", letterSpacing:".02em" },
  footerLine: { height:1, background:"linear-gradient(90deg,transparent,#181818,transparent)", marginBottom:16 },
  code: { fontFamily:"'JetBrains Mono'", background:"#0e0e0e", border:"1px solid #151515",
